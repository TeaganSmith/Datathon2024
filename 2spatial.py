...
file_path = 'csv-files-data/2021/normalized_monarch_sightings2021.csv'
...
pc = counties_sightings.plot(column='Count', ax=ax, linewidth=0.8, edgecolor='0.8', cmap='99',
                             missing_kwds={
