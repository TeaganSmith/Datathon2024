...
monarch_sightings_df['County'] = monarch_sightings_df['County'].str.lower()
temp_data_df['County'] = temp_data_df['County'].str.lower()

# Merge the two dataframes based on 'State/Province', 'County', and 'Date'
merged_df = pd.merge(monarch_sightings_df, 
                     temp_data_df[['State/Province', 'County', 'Date', 'Temp_Mean']],
